...
var agenda = function (event) {
    var a = AdfPage.PAGE.findComponentByAbsoluteId("pt1:r1:0:cd1");
    if (a.getVisible()) {
        var o = document.getElementById("pt1:r1:0:id1::content");
        if (o.value == null || o.value == "") {
            //alertas.warning('Seleccione una fecha');
