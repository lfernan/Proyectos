...
public class Util {
    ...
    private static String urlProd = "http://apps.tarjetanevada.com.ar";
    private static String urlDesa = "http://appsoasdesa.tarjetanevada.com.ar";
    
    public Util() {
    }      

    public static String urlConcatena(String url,String ambiente) {
        if (url.startsWith("http")) {
            return url.trim();
        }else if(ambiente.equalsIgnoreCase("DESARROLLO")){
            return urlDesa + url.trim();//DESARROLLO
        }        
        return urlProd + url.trim();//PRODUCCION
    }
