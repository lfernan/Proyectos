...
public interface ExpertoSegmentacionLocal {
    ...
    Long segmentar(int cantidad, String usuario, List sucursales, String pp, Campanias campania, String url, String edades, String resumen) throws SegmentacionException;
    ...
    void getSegmentacionBase(Long segmento, String url, Long tipoCamp) throws SegmentacionNoResultException;
}
