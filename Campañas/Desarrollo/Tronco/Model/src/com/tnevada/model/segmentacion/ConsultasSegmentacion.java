...
public interface ConsultasSegmentacion {
    ...
    public static String SUCURSALES_DTO = "select new com.tnevada.model.entidades.SucursalDTO(s.sucNumero,s.sucDenominacion,p.pa01DesPrv) " +
                                          "from Sucursales s, Parp001m p where p.pa01CodAlf = s.sucProvincia and s.sucActiva = 'S' order by 2 asc";
